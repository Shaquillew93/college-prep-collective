    ...
    try {
        ...
        <div style="font-family: Georgia, serif; max-width: 600px; margin: 0 auto; padding: 30px; background: #faf8f3; border-top: 4px solid #c9a84c;">
          ...
          <table style="width:100%; border-collapse: collapse; margin-bottom: 20px;">
            ...
            <tr><td style="padding: 10px 0; border-bottom: 1px solid #e8edf4; color: #8a9ab0; font-size: 12px; text-transform: uppercase; letter-spacing: 1px;">Student</td><td style="padding: 10px 0; border-bottom: 1px solid #e8edf4; color: #0d1b2e;">${studentFirst || '—'} 
          ...
          <div style="margin-top: 20px; padding: 15px; background: #c9a84c; border-radius: 2px; text-align: center;">
            <a href="mailto:${email}" style="color: #0d1b2e; font-weight: bold; text-decoration: none; font-size: 13px; letter-spacing: 1px; text-transform: uppercase;">Reach out to ${parentFirst} to schedule 
          </div>
          <p style="color: #8a9ab0; font-size: 12px; margin-top: 20px; text-align: center;">
        </div>
      `
        });
        ...
        <div style="font-family: Georgia, serif; max-width: 600px; margin: 0 auto; padding: 30px; background: #0d1b2e; border-top: 4px solid #c9a84c;">
          ...
          <p style="color: rgba(255,255,255,0.25); font-size: 11px; text-align: center;">The College Prep Collective 
        </div>
      `
        });
    ...
    try {
        ...
        <div style="font-family: Georgia, serif; max-width: 600px; margin: 0 auto; padding: 30px; background: #faf8f3; border-top: 4px solid #c9a84c;">
          ...
          <div style="margin-top: 30px; padding: 15px; background: #c9a84c; border-radius: 2px; text-align: center;">
            <a href="mailto:${email}" style="color: #0d1b2e; font-weight: bold; text-decoration: none; font-size: 14px; letter-spacing: 1px; text-transform: uppercase;">Reply to ${firstName} 
          </div>
        </div>
      `
        });
        ...
        <div style="font-family: Georgia, serif; max-width: 600px; margin: 0 auto; padding: 30px; background: #0d1b2e; border-top: 4px solid #c9a84c;">
          ...
          <p style="color: rgba(255,255,255,0.3); font-size: 12px; text-align: center;">The College Prep Collective 
        </div>
      `
        });
